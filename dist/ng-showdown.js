;/*! ng-showdown 06-10-2015 */
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    // AMD. Register as an anonymous module.
    define(['angular', 'showdown'], function (b) {
    ...
    // Browser globals
    root.returnExportsGlobal = factory(root.angular, root.showdown);
  }
  ...
  var module = angular.module('ng-showdown', ['ngSanitize']);

  module
    .provider('$showdown', ngShowdown)
    .directive('sdModelToHtml', ['$showdown', '$sanitize', '$sce', sdModelToHtmlDirective]) //<-- DEPRECATED: will be
                                                                                            // removed in the next
                                                                                            // major version release
    .directive('markdownToHtml', ['$showdown', '$sanitize', '$sce', markdownToHtmlDirective])
    .filter('sdStripHtml', ['$showdown', stripHtmlFilter]) //<-- DEPRECATED: will be removed in the next major version
                                                           // release
  ...
  function ngShowdown() {
    ...
    function SDObject() {
      ...
      /**
       * Strips a text of it's HTML tags. See
